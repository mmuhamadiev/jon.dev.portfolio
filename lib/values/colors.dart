...
class AppColors {
  ...
  static const Color primaryColor = Color(0xffd3d3d3);
  static const Color secondaryColor = Color(0xFF101010);
  static const Color accentColor = Color(0xff373d5c);
  static const Color accentColor2 = Color(0xff75809C);
  static const Color accentColor3 = Color(0xff75809C);
  static const Color complimentColor1 = Color(0xff815aa3);
  static const Color complimentColor2 = Color(0xffd91d42);
...
//  static const Color cream700 = Color(0xFFB5B8BC);
  ...
  static const Color bodyLarge = Color(0xFF8393A1);
