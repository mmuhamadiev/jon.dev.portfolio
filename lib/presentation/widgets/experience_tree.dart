...
import 'package:itsolutions.team/presentation/widgets/tree_painter.dart';
  ...
  Widget build(BuildContext context) {
    return CustomPaint(
      foregroundPainter: widget.customPainter ??
          TreePainter(
            stalk: 0.1,
            veinsColor: AppColors.complimentColor2,
            ...
            children: [
              Text(
                ...
                style: durationTextStyle ??
                    theme.textTheme.bodyMedium!.copyWith(color: AppColors.primaryColor),
              ),
              SpaceW4(),
              durationIcon ??
                  Icon(
          ...
          Text(
            ...
            style: positionTextStyle ??
                theme.textTheme.titleSmall!.copyWith(
                    fontStyle: FontStyle.italic, color: AppColors.complimentColor2),
          ),
          SpaceH8(),
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
